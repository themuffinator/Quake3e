...
`USE_SDL=0` - disable the SDL3 backend for video, audio, input subsystems and use the legacy non-SDL Unix backend instead; SDL3 is enabled by default and enforced for macOS
